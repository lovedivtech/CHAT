          ...
          <div className="w-full max-w-[500px] sm:max-w-[440px] ">
            ...
            <form className="mt-6 sm:mt-8 space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <select
                  className="w-full px-4 py-2 rounded-lg bg-white/60 text-gray-800 
                             border border-white/40 focus:outline-none focus:ring-2 
                             focus:ring-amber-700 focus:bg-white/80 transition 
            ...
            <p className="mt-6 text-center text-xs sm:text-sm text-white/70">
              ...
              <Link to="/" className="text-amber-200 hover:underline">
                Login
              </Link>
            </p>
          </div>
